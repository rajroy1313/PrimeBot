...
class TicTacToeManager {
    ...
    createGameEmbed(game) {
        ...
        if (game.status === 'active') {
            ...
            embed.setDescription(`It's ${currentPlayer}'s turn!`);
            embed.setFooter({ text: `Use $move <1-9> to make a move` });
    ...
    async makeMove({ channelId, playerId, position }) {
        ...
        // Add second player if this is their first move
